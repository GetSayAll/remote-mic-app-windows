...
- [ ] 适配 Chatterfly：已有左 Ctrl + 左 Win 预设、CABLE 路由引导、独立目标持久化、会话级 TSF 激活和读回日志；但 2026-09-23 RC003 真机测试显示，输入法已切换、模拟快捷键已提交、音频已路由，Chatterfly 仍不开麦。需找到符合第三方应用边界的可验证触发路径，完成 RC001/RC003 端到端验收后才能勾选。
