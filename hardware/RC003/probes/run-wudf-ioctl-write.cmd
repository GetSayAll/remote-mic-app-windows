@echo off
REM RC003 WUDF IOCTL write (interception) experiment -- right-click "Run as administrator".
REM
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0run-wudf-ioctl-write.ps1"
echo.
